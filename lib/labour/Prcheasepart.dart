...
class PurcheasepartsScreen extends StatefulWidget {
  const PurcheasepartsScreen({
    Key? key,
  }) : super(key: key);
  @override
  State<PurcheasepartsScreen> createState() => _PurcheasepartsScreenState();
}

final key = GlobalKey<FormState>();
var h, w;

class _PurcheasepartsScreenState extends State<PurcheasepartsScreen> {
